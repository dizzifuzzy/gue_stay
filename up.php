...
<head>
    ...
    <title><?=nama;?> - Bukti Pembayaran</title>
...
<body>
    ...
    <div class="box_general padding_bottom">
      <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Upload Bukti Pembayaran</h2>
        <hr>
      </div>
      ...
      if($_POST['simpan']){
        ...
        $gamb = $fungsi->uploadtf($namagambar,$tempgambar);
        if($gamb=="success"){
            $result = $crud->execute("INSERT INTO bukti(id_transaksi,id_member,catatan,gambar) VALUES('$idp','$idm','$catatan','$namagambar')");
            echo "Bukti Pembayaran telah sudah di Simpan.";
        }
      }
      ?>
