...
<head>
  ...
  <title><?=nama;?> - Edit Penginapan</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="box_general padding_bottom">
      <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Edit Penginapan</h2>
      </div>
        <div class="col-md-6">
        <form method="post">
        <?php 
          if($_POST['simpan']){
            ...
            $id = $_GET['id'];
            $simpan = $crud->execute("UPDATE `penginapan` SET `status_penginapan` = '$kategori' WHERE `penginapan`.`id_penginapan` = $id;");
