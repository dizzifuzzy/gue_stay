...
<head>
  ...
  <title><?=nama;?> - Update Transaksi</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="box_general padding_bottom">
      <div class="header_box version_2">
        <h2><i class="fa fa-file"></i>Update Transaksi</h2>
      </div>
        <div class="col-md-6">
        <form method="post">
        <?php 
          if($_POST['simpan']){
            $status = $_POST['status'];
            $id = $_GET['id'];
            $simpan = $crud->execute("UPDATE `transaksi` SET `status_transaksi` = '$status' WHERE `transaksi`.`id_transaksi` = $id;");
            echo "Status Transaksi Telah di ubah.";
          }
        ?>
